...
public class Main {
  ...
  public static void main(String[] args) throws Exception{
    ...
    String linuxPath = "/home/emeory/mdata/java/m3u8/";
    LessonConstant lesson = LessonConstant.Lesson15;
    M3u8VideoDownload videoDownload = new M3u8VideoDownload(10);
    //videoDownload.startDownload(lesson.getUrl(), lesson.getName(), linuxPath);
    videoDownload.startDownload("/home/emeory/Desktop/123.txt");
  }
}
